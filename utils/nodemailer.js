...
exports.sendmail = async (email,req,res,manuscript)=>{
 ...
 const mailOptions = {
    ...
    to:email,
    subject: `MECHVISTAAS Manuscript Submission - Manuscript ID No. ${manuscript.manuscriptNumber}`,
  html: `
    <p style="font-size: 22px; font-weight: 700;">WORLD JOURNAL OF ADVANCE PHARMACEUTICAL SCIENCES</p>
     ...
     <p style="font-size: 22px;">WORLD JOURNAL OF ADVANCE PHARMACEUTICAL SCIENCES has received your manuscript entitled <strong>"${manuscript.title}"</strong> for publication in MECHVISTAAS.</p>
     ...
     <p style="font-size: 20px;"> <a href="https://MECHVISTAAS.com">Track Your Article</a>.</p>
    ...
    <p style="font-size: 20px;">You are requested to convey/circulate/forward the information about World Journal of Advance Pharmaceutical Sciences to all of your friends/ teacher/ colleagues and students. For further details please visit us at: <a href="https://MECHVISTAAS.com">https://MECHVISTAAS.com</a></p>  
